...
$messages[ 'en' ] = array(
	...
	'createteams-create-teams-image-helper' => 'e.g. "[[:File:Liquidlogo std.png|Liquidlogo std.png]]"<br>The name of the team logo file. Dimensions must be 60px x 25px. To upload an image, go to [[Special:Upload]].',
	'createteams-create-teams-image-helper-remote' => 'e.g. "[[:File:Liquidlogo std.png|Liquidlogo std.png]]"<br>The name of the team logo file. Dimensions must be 60px x 25px. To upload an image, go to our [$1 upload form].',
